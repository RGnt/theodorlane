...
- Create `.env` file, and add values `OPENAI_API_KEY=""` with key if provider requires it, `BASE_URL=""` with the URL of the endpoint, and `MODEL_NAME=""` with the name of the model you wish to use (look .env.example)
